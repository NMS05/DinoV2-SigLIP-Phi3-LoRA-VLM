...
class PrismaticVLM(VLM):
    def __init__(
        ...
        #  self.string2idx = {'True': 17821, 'False': 25101, 'Yes': 5297, 'No': 2949, 'A': 32, 'B': 33, 'C': 34, 'D': 35, 'E': 36, ...... , 'W': 54, 'X': 55, 'Y': 56, 'Z': 57}
    ...
    # freeze ViT, Projector, LLM modules respectively depending on the requirement.
    def freeze_backbones(self, stage: str) -> None:
        ...
        if stage == "align":
            ...
            self.vision_backbone.requires_grad_(False)
            # self.llm_backbone.requires_grad_(True)                    #---------->>>>>>>----------->>>>>>>>>>>------>>>>>>> my changes!
            self.projector.requires_grad_(True)
