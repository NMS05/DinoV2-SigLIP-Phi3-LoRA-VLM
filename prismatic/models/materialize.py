...
from prismatic.models.backbones.llm import LLMBackbone, LLaMa2LLMBackbone, Phi2LLMBackbone, Phi3LLMBackbone
...
LLM_BACKBONES = {
    ...
    #  === Phi Backbones ===
    "phi3_base": {"cls": Phi3LLMBackbone, "kwargs": {}},                      #---------->>>>>>>----------->>>>>>>>>>>------>>>>>>> my changes!
}
